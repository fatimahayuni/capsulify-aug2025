...
export const MONTHLY_OCCASIONS = [
  { key: "work", label: "Work From Office", id: 1 },
  { key: "dates", label: "Dates", id: 2 },
  { key: "social", label: "Social Events", id: 3 },
  { key: "errands", label: "Errands/Casual", id: 4 },
  { key: "family", label: "Family/Kids", id: 5 },
  { key: "evening", label: "Evening Events", id: 6 },
  { key: "travels", label: "Travels", id: 7 },
];
