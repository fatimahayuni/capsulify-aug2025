...
const OutfitCard = (props: Props) => {
    ...
    if (isTopBottomBagShoes) {
      if (isTopBottomBagShoes_WithShorts) {
        switch (item.category_id) {
          case Category.Tops:
            return "absolute top-1/10 left-1/2 -translate-x-[calc(50%+1px)] w-25 h-25 z-40";
          case Category.Bottoms:
            return "absolute top-4/10 left-1/2 -translate-x-[calc(50%+2px)] w-18 h-18 z-40";
          case Category.Bags:
            return defaultBags;
          case Category.Shoes:
            return defaultShoes;
        ...
        switch (item.category_id) {
          case Category.Tops:
            return "absolute top-1/10 left-1/2 -translate-x-[calc(50%+1px)] w-25 h-25 z-40";
          case Category.Bottoms:
            return "absolute top-4/10 left-1/2 -translate-x-[calc(50%+1px)] w-22 h-22 z-40";
          case Category.Bags:
            return defaultBags;
          case Category.Shoes:
            return defaultShoes;
        ...
        switch (item.category_id) {
          case Category.Tops:
            return "absolute top-4 left-1/2 -translate-x-1/2 w-20 h-20 z-30";
          case Category.Bottoms:
            return "absolute top-3/10 left-1/2 -translate-x-[calc(50%+1px)] w-35 h-35 z-40";
          case Category.Bags:
            return defaultBags;
          case Category.Shoes:
            return defaultShoes;
      ...
      if (isTopBottomLayerBagShoes_WithShorts) {
        switch (item.category_id) {
          case Category.Tops:
            return "absolute top-1/10 left-1/2 -translate-x-[calc(50%+1px)] w-25 h-25 z-40";
          case Category.Bottoms:
            return "absolute top-4/10 left-1/2 -translate-x-[calc(50%+3px)] w-18 h-18 z-40";
    ...
    if (isDressLayerBagShoes) {
      switch (item.category_id) {
        case Category.Dresses:
          return "absolute top-0 left-0 w-full h-full z-30";
        case Category.Layers:
            return defaultLayers;
        case Category.Bags:
          return defaultBags;
  ...
  return (
    <div
      className="hover:translate-y-[-4px] hover:shadow-lg w-[400px] h-[300px] max-sm:w-[170px] max-sm:h-[200px] transition-all duration-300 ease-in-out relative rounded-md bg-secondary py-4 px-4"
    > 
